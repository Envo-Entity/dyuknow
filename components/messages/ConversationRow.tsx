...
export function ConversationRow({ href, mono, photo, name, sub, time, preview, unread }: ConversationRowProps) {
  return (
    <Link
      href={href}
    ...
    >
      <PhotoTile mono={mono} photoUrl={photo} monoSize={24} className="h-[54px] w-[54px] flex-none rounded-full" />
